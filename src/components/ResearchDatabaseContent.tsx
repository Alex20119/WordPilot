...
export default function ResearchDatabaseContent({
  embedded = false,
  enableTextSelection = false,
  generatingStructure = false,
  structureError = null,
}: ResearchDatabaseContentProps) {
  const { user } = useAuth()
            ...
            {generatingStructure ? (
              <>
                <div className="mb-4 flex justify-center">
                  <div className="inline-block h-10 w-10 animate-spin rounded-full border-2 border-primary-600 border-t-transparent" />
                </div>
                <p className="text-lg font-medium text-gray-900">Generating research structure...</p>
              </>
            ) : structureError ? (
              <>
                <div className="mb-4 flex justify-center">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">Could not create research structure</h3>
                <p className="text-sm text-gray-600">{structureError}</p>
              </>
            ) : (
              <>
                <div className="mb-4">
